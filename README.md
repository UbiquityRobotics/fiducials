...
Jenkins: [![Build Status](http://build.ros.org/buildStatus/icon?job=Kdev__fiducials__ubuntu_xenial_amd64&build=2)](http://build.ros.org/view/Kdev/job/Kdev__fiducials__ubuntu_xenial_amd64/2/) 
