...
/// @brief Returns a 16-bit CRC of the *size* bytes in *buffer*.
/// @param buffer is a list of bytes.
/// @param size is the number of bytes
/// @returns the 16-bit CRC of the *size* bytes in *buffer*.
///
/// *CRC__compute*() a 16-bit CRC of the *size* bytes in *buffer*.
/// Note only the low 8-bits of each 32-bit quantity in buffer is used
